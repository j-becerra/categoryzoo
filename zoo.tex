...
We write $\mathrm{Tr}(\mathcal{M})$ for the class of $\Sigma$-twisted traces on $\mathcal{M}$.
...
$$ \mathrm{Nat}(\Sigma, \mathsf{N}^r) \overset{\cong}{\to}  \mathrm{Tr}(\mathcal{M}), $$ module-compatible $\Sigma$-twisted traces correspond to  natural transformations correspond to non-degenerate $\Sigma$-twisted traces.
\end{theorem}
