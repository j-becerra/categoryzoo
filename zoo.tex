...
Let $P$ be a projective right $A$-module. Since $P$ is projective, it is a direct summand of a finite free module, i.e. there exists $n \in \mathbb{N}$ such that
\[
P \mid A^{\oplus n}.
\]
Since the functor $- \otimes_A A^*$ is additive and preserves direct summands, it suffices to prove that
\[
A \otimes_A A^* \cong A^*
\]
is injective as a right $A$-module.
